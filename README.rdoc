...
and authentication/authorization for page creation, deletion and editing to the Rails app developer to implement.
...
- Run the tiny_cms_assets generator, this will copy jquery-1.4.1, jquery-tree, a minimal version of jquer-ui 
...
- In your application layout or the layout for the resurce you created include jquery and the tiny_cms.js file:
